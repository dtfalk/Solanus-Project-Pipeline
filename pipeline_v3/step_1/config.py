...
# Target DPI
# In general (especially since these are scans... so each layer is image based)
# we will expect to see file size to increase according to a square law
# so if DPI_0 ---> File_Size_0, then (n * DPI_0) ---> (n^2 * File_Size_0)
TARGET_DPI = 300