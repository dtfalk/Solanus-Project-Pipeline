...
EDITOR_DOCUMENT = os.getenv("EDITOR_DOCUMENT", "Appendix_1").strip() or "Appendix_1"
...
class NormalizedEditorApp:
    ...
    def _build_queue_panel(self):
        ...
        tk.Label(
            header,
            text="Accept on an uncovered-ink flag adds a box for the SELECTED label type; "
                 "other flags: Go To, fix by hand, then Dismiss.",
        ...
        ttk.Button(btnrow, text="Accept",    command=self._queue_accept).pack(side=tk.LEFT, padx=6)
